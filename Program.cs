...
");
                ...
                switch (opcaoPf)
                {
                    case "1" :
                        ...
                        //StreamWriter sw = new StreamWriter($"{novaPf.nome}.txt"); //criando um arquivo 
...
//"C" moeda R$  - ? "Sim" : "Não" = if se true "sim" se for false "não" IF ternário 
            ...
            Console.ReadLine();
                        ...
                        using (StreamReader sr = new StreamReader("Nathaly.txt"))
                        {
                            string linha;
...
//                             }
            ...
            } while (opcaoPj != "0");  //opção diferente de 0 , se não vai continuar repetindo , criar essa variavel antes do DO
